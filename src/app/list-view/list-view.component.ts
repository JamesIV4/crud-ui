...
export class ListViewComponent implements OnInit {
	...
	toggleSelection(row: User) {
		...
		console.log(
			`${this.selection.hasValue() ? 'Selected' : 'Deselected'} row${
	...
	sortData(sort: Sort) {
		if (sort.direction === '') {
			// sort.direction is blank if no sorting is active
